...
var $display = (0, _jquery2.default)('<div>').addClass('checker-display').appendTo(document.body);
...
function addMessage(message, color) {
    (0, _jquery2.default)('<p>').addClass('checker-message').text(message).css('color', color).appendTo($display);
}
